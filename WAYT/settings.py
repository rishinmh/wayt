"""
Django settings for WAYT project.
...
SECRET_KEY = 'django-insecure-4r#)h)n7%7it4h=&2b!&#w7(8oiflnzy(l1*w6%vu3^f!aru&8'
...
WSGI_APPLICATION = 'WAYT.wsgi.application'
